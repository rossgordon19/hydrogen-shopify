  ...
  return (
    <div className="hero-container relative w-full h-[80vh] md:h-screen flex items-center justify-center text-black overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center z-10 h-full w-full md:justify-start">
        ...
        <button className="bg-white hover:bg-[#b1a482] text-gray-800 font-bold py-3 px-5 text-lg -mt-[100px] md:-mt-[220px] sm:py-3 sm:px-6 sm:text-xl md:py-3 md:px-6 md:text-xl lg:py-4 lg:px-8 lg:text-2xl xl:py-4 xl:px-8 xl:text-2xl rounded-full">
          Fall 23 Collection
        </button>
      </div>
    </div>
